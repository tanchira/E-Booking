        ...
        <nav class="navbar navbar-expand-custom navbar-mainbg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <section class="content" style="padding-top: 5px" >
                    ...
                    <form action="" method="GET" style="background-color:#cce6ff;">
                       
                        <div class="row">
                            <div class="col-xs-1 col-md-2 form-group"></div>
                                    ...
                                    <body>
                                        ...
                                        <table class="table table-dark table-striped table-hover">
                                            ...
                                            <tr>
                                                <td>เครื่องที่ 1</td>
                                                <td>2</td>
                                                <td>&nbsp;&nbsp;<a class="btn-xs btn bg-gradient-success" href="/editdashboard">
                                                       แก้ไข
                                                    </a>
                                                    </a>&nbsp;&nbsp;
                                                    <a type="submit"  value="Delete"  class="btn-xs btn bg-gradient-primary" href="">
                                                        ลบ
                                                    </a>
                                                </td>
