...
@section('content')
    ...
    <head>
        <title>Dashboard.CHS.RMUTI</title>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="/dashboard">กลับไปหน้า Dashboard</a>
                    </li>
                </ul>
            </div>
     ...
     <br><br><br>
                ...
                <section class="content" style="padding-top: 5px">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body" style="background-color:#cce6ff9d;">
                                    <form action="http://demo-freelancer-crm.quickadminpanel.com/admin/projects/9" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" name="_token" value="34j1xmtbE7ySDJEbTEzpS9KmzoNYADp2Gk4coXox">            <input type="hidden" name="_method" value="PUT">            
                                        <div class="form-group ">
                                            <label for="name">Name*</label>
                                            <input type="text" id="name" name="name" class="form-control" value="Florida Mueller DVM Project" required="">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <textarea id="description" name="description" class="form-control ">Molestias maiores et dolore.</textarea>
                                                            <p class="helper-block">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" id="start_date" name="start_date" class="form-control date" value="2022-08-06">
                                                            <p class="helper-block">
                                        ...
                                        <a href="/dashboard" input type="button" class="box btn bg-gradient-info w-10 my-4 mb-2">SAVE</a>
                                    </form>
