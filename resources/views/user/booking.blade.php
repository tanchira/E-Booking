                ...
                <section class="content" style="padding-top: 5px " >
                    ...
                    <div style="padding-top: 20px " class="container-fluid" >
                        <div style="margin-bottom: 10px;" class="row" >
                            <div class="col-xs-6 col-md-2 form-group"></div>
                            <div class="col-xs-6 col-md-8 form-group">
                                <label class="control-label" for="project">เลือกครุภัณฑ์</label>
                                <select name="project" class="form-control">
                                    <option value="" selected="">--- ครุภัณฑ์ทั้งหมดทั้งหมด ---</option>
                                    <a href="/booking">
                                        <option value="1">เคมีประยุกต์</option>
                                    </a>
                                    <option value="2">Onie Huel Project</option>
                                    <option value="3">Rosalyn Crooks IV Project</option>
                                    <option value="4">Vincenza Jerde I Project</option>
                                    <option value="5">Leola Runte Project</option>
                        ...
                        <input class="btn btn-primary" type="search" value="Search">
                    </div> --}}
                        </div>
                        <br><br><br><br><br>
                        </div>
                                    ...
                                    <form
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" id="start_time" name="start_time"
                                                class="form-control datetime" value="2022-07-26 02:00" required="">
                                            <p class="helper-block"></p>
                                        </div>
                                        <div class="form-group ">
                                            <label for="finish_time">เวลาเสร็จสิ้น</label>
                                            <input type="text" id="finish_time" name="finish_time"
                                                class="form-control datetime" value="2022-07-26 02:00" required="">
                                            <p class="helper-block"></p>
                                        </div>

                                        <div class="form-group ">
                                            <label for="comments">เหตุผลการยืมครุภัณฑ์</label>
                                        ...
                                        <a href="/bookingConfirm" input type="button" class="box btn bg-gradient-info w-30 my-4 mb-2">Submit</a>
                                           {{-- <a href="/bookingConfirm" class="nav-link"> <input class="btn btn-danger" ></a> --}}
