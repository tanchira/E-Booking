...
@section('content')
    ...
    <head>
        ...
        <title>Home.CHS.RMUTI</title>
        <link id="pagestyle" href="./assets/css/singin.css" rel="stylesheet" />
        ...
        <style>
            .box {
                ...
                background: linear-gradient(100deg, #003677cd 0%, #005f9fd6 35%, #008ab8cd 50%rgba(0, 183, 193, 0.799)C1 100%);
                border-radius: 8px;
            }
            ...
            .content_bg {
                ...
                -moz-box-shadow: 0 0 50px rgba(7, 11, 45, 0.377);
                box-shadow: 0 0 5px rgb(0 0 0 / 10%);
                background-color: #005f9f6e;
                padding: 200px;
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-custom navbar-mainbg">
            <a class=" navbar-logo" href=""><img src="/assets/icon/rmuti.ico.png" width="19" height="30">
                ระบบจองครุภัณฑ์ สาขา เคมีประยุกต์ คณะวิทยาศาสตร์และศิลปศาสตร์ </a>
            ...
            <div class="page-header align-items-start min-vh-100 "
                ...
                <div class="container my-auto">
                    <div class="row ">
                        ...
                        <div class="col-lg-12 col-md-12 col-6 mx-auto ">
                                ...
                                <div class="col-xs-12 col-md-12 form-group">
                                    ...
                                    <section class="content" style=" padding-top: 35px  ">
                                        ...
                                        <div id="skip" class="gcss-wrapper clear">
                                            <main id="content" class="border-color animation">
                                                <section class="content_bg">
                                                    <div class="breadcrumbs">
                                                        <ul>
                                                            <label class="control-label" for="project"
                                                                style="color:#291c75">เลือกผู้ดูแลเพื่อทำการจองครุภัณฑ์</label>
                                                            <select name="project" class="form-control">
                                                                <option value="" selected="">
                                                                    ...
                                                                    ---</option>
                                                                <a href="/booking">
                                                                    <option value="1">เคมีประยุกต์
                                                                    </option>
                                                                </a>
                                                                <option value="2">Onie Huel Project
                                                                </option>
                                                                <option value="3">Rosalyn Crooks IV
                                                                    Project
                                                                </option>
                                                                <option value="4">Vincenza Jerde I
                                                                    Project
                                                                </option>
                                                                <option value="5">Leola Runte
                                                                    Project</option>

                                                            </select>
                                                    </div>
                                                    <header>
                                                        <h2 class="icon-office" style="color:#291c75">รายการ ครุภัณฑ์</h2>
                                                    </header>
                                                    <div class="datatable " id="datatable">

                                                        <div class="tablebody" style="background: #ffffff">
                                                            <table class="fullwidth table table-hover">

                                                                <thead>
                                                                    <tr>
                                                                        <th id="#" class="mobile">รายละเอียด</th>
                                                                        <th id="c1"></th>
                                                                    </tr>
                                                                </thead>

                                                                <tbody>
                                                                    <tr id="datatable_1" class="sort " >
                                                                        <td data-text="รายละเอียด" class="top"
                                                                            headers="c1 r1" >
                                                                            <span class="term"
                                                                                style="background-color:#eb60a86c">รายการที่
                                                                                1</span>
                                                                            <p>------------------------------------</p>
                                                                        </td>
                                                                        <td data-text="" class="buttons" headers="c2 r1">
                                                                            <a class="button blue" id="booking_1"
                                                                                title="จองห้อง" tabindex="0"
                                                                                style="cursor: pointer;">
                                                                                <a class="button orange" id="detail_1"
                                                                                    title="รายละเอียด" tabindex="0"
                                                                                    style="cursor: pointer;">
                                                                                    <span class="icon-info button_w_text"
                                                                                        data-toggle="modal"
                                                                                        data-target="#myModal">
                                                                                        <span
                                                                                            class="mobile btn bg-gradient-info w-100 my-4 mb-2 box"><i
                                                                                                class="fa fa-file"
                                                                                                aria-hidden="true"></i>รายละเอียด</span>
                                                                                    </span>
                                                                                </a>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr id="datatable_2" class="sort">
                                                                        ...
                                                                        <td data-text="" class="buttons"
                                                                            headers="c2 r2">
                                                                            <a class="button blue" id="booking_2"
                                                                                title="จองห้อง" tabindex="0"
                                                                                style="cursor: pointer;"></a>
                                                                            <a class="button orange" id="detail_2"
                                                                                title="รายละเอียด" tabindex="0"
                                                                                style="cursor: pointer;">
                                                                                <span class="icon-info button_w_text">
                                                                                    <span
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div id="GModal_modaldiv" class="show">
                        <div class="modaldiv">
                            <div>
                                <article class="modal_detail">
                                    <header>
                                        <h3 class="icon-office cuttext">รายละเอียด รายการ
                                        </h3>
                                    </header>
                                    <table class="border data fullwidth">
                                        <tbody>
                                            <tr>
                                                <th>ชื่อห้อง</th>
                                                <td><span class="term" style="background-color:#265cae">ห้องประชุม
                                                        2</span></td>
                                            </tr>
                                            <tr>
                                                <th>รายละเอียด</th>
                                                <td>ห้องประชุมพร้อมระบบ Video conference<br>
                                                    ที่นั่งผู้เข้าร่วมประชุม รูปตัว U 2 แถว
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>อาคาร/สถานที่</th>
                                            ...
                                            <tr>
                                                <th>จำนวนที่นั่ง</th>
                                                <td>50 ที่นั่ง รูปตัว U</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </article>
                            </div><span class="btnclose" title="Close"></span>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <a href="/booking" input type="button" class="box btn bg-gradient-info w-30 my-4 mb-2">จอง</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            var table = new GTable("datatable", {
                "page": 1,
                "search": "",
                "sort": null,
